...
from dnsight.checks.mx.models import MXData, MXIssueId, MXRecommendationId
...
__all__ = ["MXCheck", "MXData", "MXIssueId", "MXRecommendationId", "check_mx", "get_mx"]


@register
class MXCheck(BaseCheck[MXData, BaseGenerateParams]):
    """MX check: CHECK only (MX, optional PTR and STARTTLS)."""
